...
| `wiktextract_it_typeset` | `it` | `guarded_ngram` | `safe-ngram-unicode-2x3-s1-p58-veto-unicode-3x4-s1-p80` |
...
Typesetting models apply their fragment guard after Guarded N-gram prediction,
so reusable predictions follow the same visible-fragment policy as the curated
corpus.

...
| `moby_en_us_typeset` | `en-US` | `data/gold/moby_en_us_typeset.jsonl.zst` | full curated corpus plus runtime fragment guard | `guarded_ngram` | `safe-ngram-unicode-2x3-s1-p58-veto-unicode-3x4-s1-p85` | `models/guarded_ngram/v1/moby_en_us_typeset.bin` | `manifests/guarded_ngram/v1/moby_en_us_typeset.toml` |
...
| `wiktextract_cs_typeset` | `cs` | `data/gold/wiktextract/cs_typeset.jsonl.zst` | full curated corpus plus runtime fragment guard | `guarded_ngram` | `safe-ngram-unicode-2x2-s1-p50` | `models/guarded_ngram/v1/wiktextract_cs_typeset.bin` | `manifests/guarded_ngram/v1/wiktextract_cs_typeset.toml` |
...
| `wiktextract_de_typeset` | `de` | `data/gold/wiktextract/de_typeset.jsonl.zst` | full curated corpus plus runtime fragment guard | `guarded_ngram` | `safe-ngram-unicode-2x3-s1-p58-veto-unicode-3x4-s1-p80` | `models/guarded_ngram/v1/wiktextract_de_typeset.bin` | `manifests/guarded_ngram/v1/wiktextract_de_typeset.toml` |
...
| `wiktextract_es_typeset` | `es` | `data/gold/wiktextract/es_typeset.jsonl.zst` | full curated corpus plus runtime fragment guard | `guarded_ngram` | `safe-ngram-unicode-3x2-s1-p60` | `models/guarded_ngram/v1/wiktextract_es_typeset.bin` | `manifests/guarded_ngram/v1/wiktextract_es_typeset.toml` |
...
| `wiktextract_it_typeset` | `it` | `data/gold/wiktextract/it_typeset.jsonl.zst` | full curated corpus plus runtime fragment guard | `guarded_ngram` | `safe-ngram-unicode-2x3-s1-p58-veto-unicode-3x4-s1-p80` | `models/guarded_ngram/v1/wiktextract_it_typeset.bin` | `manifests/guarded_ngram/v1/wiktextract_it_typeset.toml` |
...
| `wiktextract_nl_typeset` | `nl` | `data/gold/wiktextract/nl_typeset.jsonl.zst` | full curated corpus plus runtime fragment guard | `guarded_ngram` | `safe-ngram-unicode-2x3-s1-p58-veto-unicode-3x4-s1-p80` | `models/guarded_ngram/v1/wiktextract_nl_typeset.bin` | `manifests/guarded_ngram/v1/wiktextract_nl_typeset.toml` |
...
| `wiktextract_ru_cyrl_trusted_dedup_typeset` | `ru` | `data/gold/wiktextract/ru_cyrl_trusted_dedup_typeset.jsonl.zst` | full curated corpus plus runtime fragment guard | `guarded_ngram` | `safe-ngram-unicode-mixcv-2x3-s1-p65-veto-unicode-3x4-s1-p80` | `models/guarded_ngram/v1/wiktextract_ru_cyrl_trusted_dedup_typeset.bin` | `manifests/guarded_ngram/v1/wiktextract_ru_cyrl_trusted_dedup_typeset.toml` |
...
| `wiktextract_tr_typeset` | `tr` | `data/gold/wiktextract/tr_typeset.jsonl.zst` | full curated corpus plus runtime fragment guard | `guarded_ngram` | `safe-ngram-unicode-mixcv-2x2-s1-p70` | `models/guarded_ngram/v1/wiktextract_tr_typeset.bin` | `manifests/guarded_ngram/v1/wiktextract_tr_typeset.toml` |
